...
$config['db']['master']['database'] = 'myyp';


/*
$config['db']['master']['host'] = '127.0.0.1';
$config['db']['master']['username'] = 'meiyueyoupin';
$config['db']['master']['password'] = '3TBGBzESxJXMxer2';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'meiyueyoupin';
*/
...
$config['setting']['authkey'] = '5d550bd7';

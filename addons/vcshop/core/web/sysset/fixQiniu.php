...
class FixQiniu_VcShopPage extends WebPage
{
	...
	protected function handler()
	{
		...
		$goodsTable = tablename('vcshop_goods');
		$categoryTable = tablename('vcshop_category');
		$questionTable = tablename('vcshop_qa_question');
...
' . $updateQuestionSQL);
	...
	/**
     * 生成备份表
     * ims_vcshop_member (原表名称)
     * 生成后
     * ims_vcshop_member_copy_{$hash}表名 (备份表名)
	...
	{
		$logPath = IA_ROOT . '/addons/vcshop/data/backup';

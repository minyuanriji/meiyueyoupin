...
class Print_VcShopPage extends WebPage 

{
	...
	public function shengchan(){
		...
		$stores[$key] = pdo_fetchall('select * from ' . tablename('vcshop_order') . ' where uniacid=:uniacid and id=:orderid', array(':uniacid' => $uniacid,':orderid' => $orderId));		

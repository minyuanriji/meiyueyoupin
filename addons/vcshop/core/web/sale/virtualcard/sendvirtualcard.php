...
class Sendvirtualcard_VcShopPage extends ComWebPage
{
	...
	public function main()
	{
		...
		$coupons = pdo_fetchall('SELECT * FROM ' . tablename('vcshop_coupon') . (' WHERE uniacid = \'' . $_W['uniacid'] . '\' and merchid=0 and isfriendcoupon = 0  ORDER BY id asc'));
		$hascommission = false;

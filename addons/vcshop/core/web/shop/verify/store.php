...
class Store_VcShopPage extends ComWebPage
{
	...
	public function query()
	{
		...
		$ds = pdo_fetchall('SELECT id,storename,logo as thumb FROM ' . tablename('vcshop_store') . (' WHERE 1 ' . $condition . ' order by id asc'), $params);

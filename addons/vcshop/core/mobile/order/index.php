...
class Index_VcShopPage extends MobileLoginPage
{
    ...
    public function detail()
    {
        ...
        if (!empty($order["virtual"]) && !empty($order["virtual_str"])) {
            ...
            $virtualtemp = pdo_fetch("SELECT linktext, linkurl,description FROM " . tablename("vcshop_virtual_type") . " WHERE id=:id AND uniacid=:uniacid LIMIT 1", array(":id" => $order["virtual"], ":uniacid" => $_W["uniacid"]));
        }

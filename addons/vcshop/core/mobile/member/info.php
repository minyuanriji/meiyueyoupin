...
class Info_VcShopPage extends MobileLoginPage
{
	protected $member;
	...
	public function submit()
	{
		...
		if ($template_flag == 1) {
			...
			pdo_update('vcshop_member', $m_data, array('openid' => $_W['openid'], 'uniacid' => $_W['uniacid']));
	...
	public function face()
	{
		...
		if ($_W['ispost']) {
			...
			pdo_update('vcshop_member', array('avatar' => $avatar, 'nickname' => $nickname), array('id' => $member['id'], 'uniacid' => $_W['uniacid']));
			show_json(1);
		}

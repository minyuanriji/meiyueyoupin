...
class Code_VcShopPage extends MobilePage
{
	public function main()
	{
		...
		$codegoods = pdo_fetch('SELECT * FROM ' . tablename('vcshop_goodscode_good') . ' WHERE
		...
		$goods = pdo_fetch('SELECT title,content FROM ' . tablename('vcshop_goods') . ' WHERE

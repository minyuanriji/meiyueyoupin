...
class Register_VcShopPage extends DividendMobileLoginPage
{
	public function main()
	{
		...
		if ($set['condition'] == 1) {
			...
			$status = 1;
			$commissiondownlinecount = pdo_fetchcolumn('select count(*) from ' . tablename('vcshop_member') . ' where  agentid = ' . $member['id'] . ' and isagent = 1 and id <> ' . $member['id'] . '  and uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid']));

...
class Picker_VcShopPage extends PluginMobilePage
{
	...
	public function getLevel($openid)
	{
		...
		$clevel = pdo_fetch('select * from ' . tablename('vcshop_commission_level') . ' where uniacid=:uniacid and id=:id limit 1', array(':uniacid' => $_W['uniacid'], ':id' => $member['agentlevel']));
		return $clevel;
	}
}

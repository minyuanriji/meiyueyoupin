...
class Release_VcShopPage extends PluginWebPage
{
	...
	public function main()
	{
		...
		if (is_error($auth)) {
			...
			$authUrl = VCSHOP_AUTH_WXAPP . 'index/index/xcxAuth.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'];
	...
	public function audit()
	{
		...
		if ($action == 'upload') {
			...
			$request = ihttp_post(VCSHOP_AUTH_WXAPP . 'index/index/submitCode3.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array('tabBar' => $tabBar));
		}
		else {
			$request = ihttp_post(VCSHOP_AUTH_WXAPP . 'index/index/auditCode.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array());
		}
	...
	public function auth()
	{
		...
		header('Location:' . VCSHOP_AUTH_WXAPP . 'index/index/xcxAuth?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid']);
	}

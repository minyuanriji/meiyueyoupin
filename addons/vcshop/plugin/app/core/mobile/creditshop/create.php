...
class Create_VcShopPage extends AppMobilePage
{
	...
	public function getaddress()
	{
		...
		if (!empty($_GPC['addressid'])) {
			$address = pdo_fetch('select * from ' . tablename('vcshop_member_address') . ' where openid=:openid and deleted=0  and uniacid=:uniacid and id =:id limit 1', array(':uniacid' => $uniacid, ':openid' => $openid, ':id' => $_GPC['addressid']));

...
class List_VcShopPage extends AppMobilePage
{
	public function main()
	{
		...
		if (!empty($total)) {
			$sql = 'SELECT id,title,thumb,price,groupnum,groupsprice,category,isindex,goodsnum,units,sales,description,stock FROM ' . tablename('vcshop_groups_goods') . '

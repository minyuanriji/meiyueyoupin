...
function app_json($result = NULL, $openid)
{
	...
	$ret['error'] = 0;
	$key = time() . '@' . $openid;
	$auth = array('authkey' => base64_encode(authcode($key, 'ENCODE', 'vcshop_wxapp')));
...
require VCSHOP_PLUGIN . 'app/core/error_code.php';
require VCSHOP_PLUGIN . 'app/core/wxapp/wxBizDataCrypt.php';
class Wxapp_VcShopPage extends Page
{
	protected $appid;
	protected $appsecret;

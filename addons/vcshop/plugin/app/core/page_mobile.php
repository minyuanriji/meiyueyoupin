...
require_once VCSHOP_PLUGIN . 'app/core/error_code.php';
$iswxapp = false;
$openid = '';
...
';
	...
	private function checkUniacid()
	{
		...
		$bind = pdo_fetch('SELECT * FROM ' . tablename('vcshop_wxapp_bind') . ' WHERE wxapp=:wxapp LIMIT 1', array(':wxapp' => $_W['uniacid']));

...
class Detail_VcShopPage extends PluginMobileLoginPage
{
	...
	public function pay($a = array(), $b = array())
	{
		...
		if ($needpay) {
			...
			pdo_update('vcshop_creditshop_log', array('paytype' => $useweixin ? 1 : 0), array('id' => $logid));
	...
	public function lottery()
	{
		...
		pdo_update('vcshop_creditshop_goods', array('joins' => $goods['joins'] + 1), array('id' => $id));

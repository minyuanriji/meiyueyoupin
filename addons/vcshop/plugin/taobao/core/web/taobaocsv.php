...
class Taobaocsv_VcShopPage extends PluginWebPage
{
	public function main()
	{
		...
		$uploadStart = '0';
		$uploadnum = '0';
		$excelurl = $_W['siteroot'] . 'addons/vcshop/plugin/taobao/data/test.xlsx';
		$zipurl = $_W['siteroot'] . 'addons/vcshop/plugin/taobao/data/test.zip';

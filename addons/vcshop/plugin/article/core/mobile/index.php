...
class Index_VcShopPage extends PluginMobilePage
{
	...
	public function getcontent()
	{
		...
		$article = pdo_fetch('SELECT article_content FROM ' . tablename('vcshop_article') . ' WHERE id=:aid and article_state=1 and uniacid=:uniacid limit 1 ', array(':aid' => $aid, ':uniacid' => $_W['uniacid']));

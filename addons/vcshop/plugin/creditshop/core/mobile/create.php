...
class Create_VcShopPage extends PluginMobileLoginPage
{
	...
	public function dispatch()
	{
		...
		$address = pdo_fetch('select id,realname,mobile,address,province,city,area,datavalue,street from ' . tablename('vcshop_member_address') . '

...
class Credit_VcShopPage extends CashierWebPage
{
	...
	public function recharge_submit()
	{
		...
		pdo_delete('vcshop_cashier_log', array('cashierid' => $_W['cashierid'], 'status' => 0, 'uniacid' => $_W['uniacid']));
		pdo_insert('vcshop_cashier_log', $log);
		$logid = pdo_insertid();

...
class Sysset_VcShopPage extends CashierWebPage
{
	...
	public function userset()
	{
		...
		if (!empty($item['manageopenid'])) {
			...
			$manageopenid = pdo_fetchall('SELECT id,openid,avatar,nickname FROM ' . tablename('vcshop_member') . ' WHERE uniacid=:uniacid AND openid IN (' . $openids . ')', array(':uniacid' => $_W['uniacid']));
		}

...
if ($operation == 'display') {
	...
	if ($operation == 'exchange') {
		...
		pdo_update('vcshop_creditshop_log', array('status' => 3, 'usetime' => time(), 'expresscom' => $_GPC['expresscom'], 'expresssn' => $_GPC['expresssn'], 'express' => $_GPC['express']), array('id' => $id));

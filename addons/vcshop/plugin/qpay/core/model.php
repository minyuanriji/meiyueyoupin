...
class QpayModel extends PluginModel
{
	...
	public function RequestHandler()
	{
		...
		$this->notify_url = $_W['siteroot'] . 'addons/vcshop/payment/wechat/notify.php';
	}
	...
	public function build($params, $account = array(), $type)
	{
		...
		$this->setParameter('device_info', isset($this->params['device_info']) ? 'vcshop:' . $this->params['device_info'] : 'vcshop');

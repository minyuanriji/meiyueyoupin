...
class Order_VcShopPage extends MerchWebPage
{
	public function main()
	{
		...
		$sql = 'select o.*, a.realname as addressname,m.realname from ' . tablename('vcshop_order') . ' o ' . ' left join ' . tablename('vcshop_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('vcshop_member_address') . ' a on a.id = o.addressid ' . (' where 1 ' . $condition . ' ');
		...
		$count = pdo_fetch('select count(o.id) as count from ' . tablename('vcshop_order') . ' o ' . ' left join ' . tablename('vcshop_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('vcshop_member_address') . ' a on a.id = o.addressid ' . (' where 1 ' . $condition), $params);

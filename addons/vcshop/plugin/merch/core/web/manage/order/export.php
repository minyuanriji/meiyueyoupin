...
class Export_VcShopPage extends MerchWebPage
{
...
';
		...
		$stores = pdo_fetchall('select id,storename from ' . tablename('vcshop_merch_store') . ' where uniacid=:uniacid and merchid = :merchid', array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));

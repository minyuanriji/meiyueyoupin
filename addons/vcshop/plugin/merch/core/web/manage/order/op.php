...
class Op_VcShopPage extends MerchWebPage
{
	public function delete()
	{
		...
		pdo_update('vcshop_order', array('deleted' => 1), array('id' => $orderid, 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	protected function opData()
	{
		...
		global $_GPC;
		$id = intval($_GPC['id']);
		$item = pdo_fetch('SELECT * FROM ' . tablename('vcshop_order') . ' WHERE id = :id and uniacid=:uniacid and merchid = :merchid', array(':id' => $id, ':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
	...
	public function changeprice()
	{
		...
		if ($_W['ispost']) {
			...
			foreach ($changegoodsprice as $ogid => $change) {
				$og = pdo_fetch('select price,realprice from ' . tablename('vcshop_order_goods') . ' where id=:ogid and uniacid=:uniacid and merchid = :merchid limit 1', array(':ogid' => $ogid, ':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
			...
			if (!empty($orderupdate)) {
				pdo_update('vcshop_order', $orderupdate, array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
			}
			...
			foreach ($changegoodsprice as $ogid => $change) {
				$og = pdo_fetch('select price,realprice,changeprice from ' . tablename('vcshop_order_goods') . ' where id=:ogid and uniacid=:uniacid and merchid = :merchid limit 1', array(':ogid' => $ogid, ':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
	...
	public function pay($a = array(), $b = array())
	{
		...
		if (!empty($item['virtual']) && com('virtual')) {
			...
			pdo_update('vcshop_order', array('status' => 1, 'paytype' => 11, 'paytime' => time()), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function close()
	{
		...
		if ($_W['ispost']) {
			...
			if (0 < $item['refundstate'] && !empty($item['refundid'])) {
				...
				pdo_update('vcshop_order_refund', $change_refund, array('id' => $item['refundid'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
			}
	...
	public function paycancel()
	{
		...
		if ($_W['ispost']) {
			m('order')->setStocksAndCredits($item['id'], 2);
			pdo_update('vcshop_order', array('status' => 0, 'cancelpaytime' => time()), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function finish()
	{
		...
		pdo_update('vcshop_order', array('status' => 3, 'finishtime' => time()), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function fetchcancel()
	{
		...
		pdo_update('vcshop_order', array('status' => 1, 'finishtime' => 0), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
...
' . $remark;
			...
			pdo_update('vcshop_order', array('status' => 1, 'sendtime' => 0, 'remarksend' => $remark), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function fetch()
	{
		...
		pdo_update('vcshop_order', $d, array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function send()
	{
		...
		if ($_W['ispost']) {
			...
			$time = time();
			pdo_update('vcshop_order', array('status' => 2, 'express' => trim($_GPC['express']), 'expresscom' => trim($_GPC['expresscom']), 'expresssn' => trim($_GPC['expresssn']), 'sendtime' => $time), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function remarksaler()
	{
		...
		if ($_W['ispost']) {
			pdo_update('vcshop_order', array('remarksaler' => $_GPC['remark']), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function changeexpress()
	{
		...
		if ($_W['ispost']) {
			...
			if (!empty($expresssn)) {
				...
				pdo_update('vcshop_order', $change_data, array('id' => $id, 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
	...
	public function changeaddress()
	{
		...
		if ($_W['ispost']) {
			...
			if (!empty($id)) {
				...
				$item = pdo_fetch('SELECT id, ordersn, address FROM ' . tablename('vcshop_order') . ' WHERE id = :id and uniacid=:uniacid and merchid = :merchid', array(':id' => $id, ':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
				...
				pdo_update('vcshop_order', array('address' => $address_array), array('id' => $id, 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));

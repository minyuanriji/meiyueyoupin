...
class Ccard_VcShopPage extends CommissionMobileLoginPage
{
	...
	public function get_list()
	{
		...
		$sql = 'select * from ' . tablename('vcshop_ccard') . ' where status = 1 and uniacid=:uniacid and (agentid1 = :uid or agentid2 = :uid) order by id desc LIMIT ' . ($pindex - 1) * $psize . ',' . $psize;
		$sql1 = 'select count(1) from ' . tablename('vcshop_ccard') . ' where status = 1 and uniacid=:uniacid and (agentid1 = :uid or agentid2 = :uid)';

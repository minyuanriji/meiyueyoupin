...
class Index_VcShopPage extends CommissionMobileLoginPage
{
	public function main()
	{
		...
		$profile = m('member')->getMember($_W['openid'], true);
		// zhou 20191121 获取当前能充值的等级  游客没有s
		...
		// zhou 20191121 获取当前能充值的等级  游客没有e

...
base_module.controller(
    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_type': function () {
                    ...
                    $http.get(
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.market.getType"
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.market.getList&page=1"
                ...
                'add_market': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.market.addInfo',
                ...
                'delete_market': function (id) {
                    ...
                    if (confirm('确定要删除该兑换商品吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.market.deleteInfo',
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.market.getList&page=1");

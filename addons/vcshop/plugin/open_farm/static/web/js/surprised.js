...
base_module.controller(
    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_category': function () {
                    ...
                    $http.get(
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.getCategory"
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.getList&page=1"
                ...
                'add_surprised': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.addInfo',
                ...
                'delete_surprised': function (id) {
                    ...
                    if (confirm('确定要删除该彩蛋吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.deleteInfo',
                ...
                'delete_all_surprised': function (id) {
                    ...
                    if (confirm('确定要删除该彩蛋吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.deleteAll',
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.surprised.getList&page=1");

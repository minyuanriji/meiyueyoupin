            ...
            $scope.function = {
                ...
                'list_show': function () {
                    ...
                    $scope.function.get_list(
                        ...
                        "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.getList"
                ...
                'get_category': function () {
                    ...
                    $http.get(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.getCategory'
                ...
                'get_core': function () {
                    ...
                    $http.get(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.getTaskCore'
                ...
                'get_member_level': function () {
                    ...
                    $http.get(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.getMemberLevel'
                ...
                'get_goods': function () {
                    ...
                    $http.get(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.getGoods'
                ...
                'add_info': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.addInfo',
                ...
                'delete_info': function (id) {
                    ...
                    if (confirm('真的要删除该数据吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.task.deleteInfo',

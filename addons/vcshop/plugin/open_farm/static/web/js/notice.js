...
base_module.controller(
    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.notice.getList&page=1"
                ...
                'add_notice': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.notice.addInfo',
                ...
                'delete_notice': function (id) {
                    ...
                    if (confirm('确定要删除该公告吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.notice.deleteInfo',
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.notice.getList&page=1");

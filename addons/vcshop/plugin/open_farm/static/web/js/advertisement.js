...
base_module.controller(
    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_advertisement_max': function () {
                    ...
                    $http.get(
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.seting.getAdvertisementMax"
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.advertisement.getList&page=1"
                ...
                'add_advertisement': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.advertisement.addInfo',
                ...
                'delete_advertisement': function (id) {
                    ...
                    if (confirm('确定要删除该广告吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.advertisement.deleteInfo',
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.advertisement.getList");

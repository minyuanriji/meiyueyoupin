...
base_module.controller(
    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        ...
                        url = "/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.reply.getList&page=1"
                ...
                'add_reply': function () {
                    ...
                    $http.post(
                        ...
                        '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.reply.addInfo',
                ...
                'delete_reply': function (id) {
                    ...
                    if (confirm('确定要删除该回复吗?')) {
                        ...
                        $http.post(
                            ...
                            '/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.reply.deleteInfo',
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=vcshop&do=web&r=open_farm.reply.getList&page=1");

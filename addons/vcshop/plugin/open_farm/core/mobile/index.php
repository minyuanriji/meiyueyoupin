...
class Index_VcShopPage extends PluginMobilePage
{
     ...
     * @var string
     */
	private $userTable = 'vc_open_farm_user';
	/**
     * 用户鸡信息数据表名称
     * @var string
     */
	private $chickenTable = 'vc_open_farm_chicken';
	/**
     * 默认openid
     * @var string
     */
	...
	public function main()
	{
		global $_W;
		$this->authorization();
		$configInfo = pdo_get('vc_open_farm_configure', array('uniacid' => $_W['uniacid']));

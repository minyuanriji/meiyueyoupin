...
class Mood_VcShopPage extends PluginMobilePage
{
	/**
     ...
     */
	private $table = 'vc_open_farm_mood';
	/**
     ...
     */
	private $sonTable = 'vc_open_farm_mood_image';
	/**
	...
	public function generateMood()
	{
		...
		$imageUrl = $_W['siteroot'] . 'addons/vcshop/plugin/open_farm/static/mobile/mood/' . $saveName;

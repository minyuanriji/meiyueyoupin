...
class Configure_VcShopPage extends PluginWebPage
{
	/**
     ...
     */
	private $table = 'vc_open_farm_configure';
	/**
     ...
     * Configure_VcShopPage constructor.
	...
	public function setReplyKeywordRule($configure)
	{
		global $_W;
		$rule = $this->getRule();
		$replyData = array('uniacid' => $_W['uniacid'], 'rid' => $rule['id'], 'module' => 'vcshop', 'title' => $configure['title'], 'description' => $configure['describe'], 'thumb' => $configure['logo'], 'url' => $configure['url']);
	...
	public function getRule()
	{
		global $_W;
		$table = 'rule';
		$data = array('uniacid' => $_W['uniacid'], 'name' => 'vcshop:open:open_farm', 'module' => 'vcshop', 'status' => '1');

define(['core', 'tpl'], function(core, tpl) {
	...
	modal.payWechat = function(btn) {
		...
		if(type=='wechat'){
			...
			if(type=='helibao_wechat'){
				var wechat = modal.params.helibao_wechat.wopt;
				if (!modal.params.helibao_wechat.success) {
					FoxUI.toast.show(wechat)
					return
				}
				go = modal.params.helibao_wechat.success;
			}
		}
		// if (wechat.weixin) {
		if (go) {

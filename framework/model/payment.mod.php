...
function payment_types($type = '') {
	$pay_types= array(
		...
		'unionpay' => '银联支付',
		'baifubao' => '百度钱包支付',
		'tonglian_wechat' => '通联微信支付',
		'tonglian_alipay' => '通联支付宝支付',
		'helibao_wechat' => '合利宝微信支付',
		'line' => '汇款支付',
		'jueqiymf' => '一码支付'
	);
...
function payment_setting() {
	...
	// 合利宝
	if (empty($pay_setting['helibao_wechat'])) {
		$pay_setting['helibao_wechat'] = array(
			'recharge_switch' => false,
			'pay_switch' => false,
			'mchid' => '',
			'key' => '',
	...
	// 通联
	if (empty($pay_setting['tonglian_wechat'])) {
		$pay_setting['tonglian_wechat'] = array(
			'recharge_switch' => false,
			'pay_switch' => false,
			'mchid' => '',
			'appid' => '',
	...
	if (empty($pay_setting['tonglian_alipay'])) {
		$pay_setting['tonglian_alipay'] = array(
			'recharge_switch' => false,
			'pay_switch' => false,
			'mchid' => '',
			'appid' => '',
